...
import { FiFileText, FiDollarSign, FiUsers, FiClipboard, FiRefreshCcw, FiBarChart2 } from 'react-icons/fi';
...
export const services = [
  {
    ...
    url: '/uslugi/new-vedenie-buhgalterskogo-ucheta',
    fullDescription: `
  ...
  },
  {
    ...
    url: '/uslugi/vedenie-pervichnoj-dokumentacii',
    fullDescription: `
