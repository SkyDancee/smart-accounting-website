  ...
  return (
    <section id={id} className={`py-20 ${className}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#c9a875] to-[#b8956a] rounded-xl p-10 shadow-lg" data-aos="fade-up">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            {onGetConsultation ? (
              <button
                ...
                className="bg-white hover:bg-gray-50 text-[#c9a875] px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg cursor-pointer"
              >
              ...
              <a
                href="/contact"
                className="bg-white hover:bg-gray-50 text-[#c9a875] px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-lg inline-block"
              >
                Получить консультацию
              </a>
            )}
