...
import { FiCheck, FiArrowRight, FiStar, FiUsers, FiBarChart2, FiCalendar, FiFileText, FiShield, FiDollarSign, FiX } from 'react-icons/fi';
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 p-12 relative overflow-hidden group hover:shadow-3xl transition-all duration-500">
                ...
                <div className="relative z-10">
                  <div className="w-20 h-20 bg-gradient-to-br from-[#c9a875] to-[#b8956a] rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up" data-aos-delay="100">
            <TestimonialCard
                              text="Очень доволен сотрудничеством! Специалисты Smart Accounting помогли нам оптимизировать налоговую нагрузку и навести порядок в бухгалтерии."
              author="Шерзод Каримов"
              position="Генеральный директор, ООО «ARTEL»"
            />
            <TestimonialCard
                              text="Smart Accounting bilan 3 yildan beri ishlaymiz. Doimo aloqada, savollarga tezda javob berishadi, murakkab vaziyatlarda yordam berishadi. Tavsiya qilaman!"
              author="Дилором Абдуллаева"
              position="Moliya direktori, ООО «ORIENT GROUP»"
            />
            <TestimonialCard
                              text="Обратился в Smart Accounting, когда открывал свой первый бизнес. Помогли с регистрацией, выбором системы налогообложения и организацией учета. Очень доволен!"
              author="Фаррух Салимов"
              position="Директор, ООО «MASTER YULI GROUP»"
            />
          </div>
        </div>
      </section>
