...
import { FiDollarSign, FiCheck, FiUsers, FiShield, FiArrowRight } from 'react-icons/fi';
  ...
  return (
    <Layout>
      ...
      <div className="container mx-auto px-4 pt-32 pb-20">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-16 text-gray-900">Контакты</h1>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-1 mb-8">
                  <div className="w-full h-[350px] lg:h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gray-200">
                    <iframe 
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2992.8!2d69.149283!3d41.271915!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDHCsDE2JzE4LjkiTiA2OcKwMDgnNTcuNCJF!5e0!3m2!1sen!2sus!4v1715183693412!5m2!1sen!2sus"
                      width="100%" 
                      height="100%" 
                      style={{ border: 0 }} 
                      allowFullScreen 
                ...
                <div className="text-center bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  ...
                  <p className="text-gray-700 leading-relaxed text-base">
                    Qovunchi ko'chasi, 31-mavze, 55A<br />
                    Uchtepa, Tashkent, Uzbekistan
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-gray-100">
          ...
          <div className="border-t border-gray-200 pt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="text-center p-6 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm">
                <p className="text-base text-gray-700 leading-relaxed">
                  <span className="font-bold text-gray-900">На метро:</span><br />
                  станция "Uchtepa", район Учтепа
                </p>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm">
                <p className="text-base text-gray-700 leading-relaxed">
                  <span className="font-bold text-gray-900">На машине:</span><br />
